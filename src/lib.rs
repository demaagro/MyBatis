...
#[derive(Debug)]
pub struct MyBatisSQLProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MyBatisSQLProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MyBatisSQL processing");
    
    let mut processor = MyBatisSQLProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MyBatisSQLProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MyBatisSQLProcessor::new(false);
